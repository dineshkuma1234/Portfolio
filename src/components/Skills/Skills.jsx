    ...
    >
      <div className="text-center mb-8">
        ...
        <p className="text-gray-400 mt-4 text-lg font-semibold">
          A showcase of my technical skills and expertise, refined through
      ...
      <div className="flex flex-wrap gap-1 lg:gap-5 py-10 justify-between">
        {SkillsInfo.map((category) => (
          ...
          >
            <h3 className="text-center text-gray-400 font-semibold text-2xl sm:text-3xl">
              {category.title}
            </h3>

            {/* Skill Item -3 per row on large screen */}
            <Tilt
