  ...
  return (
    ...
    >
      <div className="text-center mb-16">
        <h2 className="font-bold text-white text-4xl">EXPERIENCE</h2>
        <div className="w-32 h-1 bg-purple-500 mx-auto mt-4"></div>
        <p className="text-gray-400 mt-4 text-lg font-semibold">
          {" "}
          A curated showcase of my professional experience and key roles across
      ...
      <div className="relative">
        ...
        {experiences.map((experience, index) => (
          ...
          >
            {/* Timeline Circle img on the line only  */}
            ...
            >
              ...
              <div className="flex items-center space-x-6">
                ...
                <div className="flex flex-col justify-between">
                  <div>
                    <h3 className=" text-xl sm:text-2xl text-white tex font-semibold">
                      {experience.role}
                    </h3>
              ...
              <p className="mt-4 text-gray-400 text-justify max-w-prose leading-relaxed">{experience.desc}</p>
